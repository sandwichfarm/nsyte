...
export function detectPlatformsFromFileName(fileName: string): string[] {
  ...
  if (
    lowerName.includes("windows") || lowerName.includes("win32") || lowerName.includes("win64") ||
    lowerName.endsWith(".exe") || lowerName.includes("msvc")
  ) {
    platforms.push("windows");
  }
  if (
    lowerName.includes("macos") || lowerName.includes("darwin") || lowerName.includes("osx") ||
    lowerName.endsWith(".dmg") || lowerName.endsWith(".pkg")
  ) {
