...
- [x] **Phase 22: AUR Pipeline** - AUR publish job and runbook are implemented; live AUR push UAT remains external.
- [x] **Phase 23: Homebrew Tap Pipeline** - Homebrew publish job and runbook are implemented; live tap push/macOS install UAT remains external.
- [x] **Phase 24: Scoop Bucket Pipeline** - Scoop publish job and runbook are implemented; live bucket push/Windows install UAT remains external.
- [x] **Phase 25: Winget Pipeline** - Winget update job and bootstrap docs are implemented; winget index/bootstrap UAT remains external.
- [x] **Phase 26: Nix Flake** - Nix flake update job is implemented; live `publish-nix` CI and local Nix smoke UAT remain external.
...
**Plans**: 1 plan
  - [x] 23-01-PLAN.md - Replace publish-homebrew stub with tap update pipeline and runbook
...
**Plans**: 1 plan
  - [x] 24-01-PLAN.md - Replace publish-scoop stub with bucket update pipeline and runbook
...
**Plans**: 1 plan
  - [x] 25-01-PLAN.md - Replace publish-winget stub with wingetcreate update pipeline and bootstrap runbook
...
**Plans**: 1 plan
  - [x] 26-01-PLAN.md - Replace publish-nix stub with flake hash update pipeline
...
| 25. Winget Pipeline | v1.6 | 1/1 | Human UAT pending | 2026-05-07 |
| 26. Nix Flake | v1.6 | 1/1 | Human UAT pending | 2026-05-07 |
